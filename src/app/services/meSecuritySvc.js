...
(function () {
     ...
     * enough priviledges for the new/current route. Namely:
     ...
     * 
     * Also, if the user drops on the page (i.e. open a direct link, rather than changiing fragment within the page,
